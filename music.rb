...
def list_artists(art)
  art.each_key |artist_song|
  puts artist_song
end
...
def delete_artist(art, artist_song)
  art.delete(artist_song)
  art
end
...
def addArtist(hash, artist, song)
  hash[artist] = song
  hash
end
